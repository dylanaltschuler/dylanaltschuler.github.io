...
export default function Home() {
  ...
  const visiblePapers = useMemo(() => {
    return papers.filter(
      (paper) =>
        (!topic || paper.tags.includes(topic)) &&
        (aiLevel === null || paper.ai === aiLevel),
    );
  }, [topic, aiLevel]);

  const hasFilters = topic !== null || aiLevel !== null;
      ...
      <section className="publications-section" id="publications">
        ...
        <div className="filter-panel">
          ...
          <div className="filter-controls">
            <fieldset className="filter-group ai-filter">
              <legend>
                AI scale
                <span className="ai-scale-info">
                  ...
                  >
                    ...
                    <span>
                      <b>2</b> — AI used as a mathematics aide: suggested a
                      minor innovation or automated a standard computation.
                    </span>
                    <span>
              ...
              <div className="filter-options">
                <button
                  className={
                    aiLevel === null ? "filter-chip active" : "filter-chip"
                  }
                  type="button"
                  aria-pressed={aiLevel === null}
                  onClick={() => setAiLevel(null)}
                >
                  Any
                </button>
                {[0, 1, 2, 3, 4, 5].map((level) => (
                  <button
                    className={
                      aiLevel === level ? "filter-chip active" : "filter-chip"
                    }
                    type="button"
                    aria-label={`AI contribution ${level} out of 5`}
                ...
                <article>
                  <div className="paper-heading">
                    ...
                    <div className="paper-tags" aria-label="Paper tags">
                      ...
                      <button
                        className={`tag ai-tag ai-${paper.ai} tag-button${
                          aiLevel === paper.ai ? " selected" : ""
                        }`}
                        type="button"
                        aria-label={`Filter by AI contribution ${paper.ai} out of 5`}
                        aria-pressed={aiLevel === paper.ai}
                        onClick={() =>
                          setAiLevel(aiLevel === paper.ai ? null : paper.ai)
                        }
                      >
                        AI {paper.ai}/5
                      </button>
